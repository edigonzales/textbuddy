...
class HomePageMvcTest {
    ...
    void getRootRendersEditorIslandShell() throws Exception {
        ...
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("data-testid=\"editor-copy\"")))
                .andExpect(content().string(containsString("data-testid=\"editor-download\"")))
                .andExpect(content().string(containsString("data-testid=\"editor-stats-toggle\"")))
                ...
                .andExpect(content().string(containsString("data-compatibility-host hidden inert")))
                ...
                .andExpect(content().string(containsString("data-testid=\"review-inline\"")))
                .andExpect(content().string(containsString("data-testid=\"review-split\"")))
