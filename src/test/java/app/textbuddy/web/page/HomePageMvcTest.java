...
class HomePageMvcTest {
    ...
    void getRootRendersEditorIslandShell() throws Exception {
        ...
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("GET /api/advisor/docs")))
                .andExpect(content().string(containsString("GET /api/advisor/doc/{name}")))
                .andExpect(content().string(containsString("Referenzdokumente")))
                .andExpect(content().string(containsString("Mehrfachauswahl")))
