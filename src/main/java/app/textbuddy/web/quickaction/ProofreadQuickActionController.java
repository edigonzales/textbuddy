...
public class ProofreadQuickActionController {
    ...
    public SseEmitter streamProofread(@RequestBody QuickActionStreamRequest request, HttpServletRequest httpServletRequest) {
        ...
        Thread.startVirtualThread(() -> {
            try {
                ...
                log.error("[{}] Proofread stream failed.", traceId, exception);
