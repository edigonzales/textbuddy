...
@Service
public class SocialMediaQuickActionService {
    ...
    public SocialMediaQuickActionService(SocialMediaLlmClient socialMediaLlmClient) {
        this.socialMediaLlmClient = socialMediaLlmClient;
    }
    ...
    public void stream(QuickActionStreamRequest request, QuickActionStreamHandler handler) {
        ...
        Optional<SocialMediaPrompt> prompt = SocialMediaPrompt.fromOption(request == null ? null : request.option());
        ...
        try {
            List<String> chunks = socialMediaLlmClient.streamSocialMedia(original, language, prompt.get());
