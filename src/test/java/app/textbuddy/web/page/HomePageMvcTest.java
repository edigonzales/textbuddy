...
class HomePageMvcTest {
    ...
    void getRootRendersEditorIslandShell() throws Exception {
        ...
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("POST /api/quick-actions/bullet-points/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/proofread/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/summarize/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/formality/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/social-media/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/medium/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/character-speech/stream")))
                .andExpect(content().string(containsString("POST /api/quick-actions/custom/stream")))
