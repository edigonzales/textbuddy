...
class HomePageMvcTest {
    ...
    void getRootRendersEditorIslandShell() throws Exception {
        ...
        mockMvc.perform(get("/"))
                ...
                .andExpect(content().string(containsString("Bei aktiver OIDC-Konfiguration laeuft der Endpoint nur fuer angemeldete Sessions.")))
                ...
                .andExpect(content().string(containsString("dasselbe konsistente Fehler- und Auth-Verhalten")))
