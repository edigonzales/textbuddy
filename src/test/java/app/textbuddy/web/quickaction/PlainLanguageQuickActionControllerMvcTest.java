...
@SpringBootTest
class PlainLanguageQuickActionControllerMvcTest {

    @Autowired
    private WebApplicationContext webApplicationContext;

    @Test
    void postPlainLanguageStreamReturnsSseChunksAndCompleteEvent() throws Exception {
        MockMvc mockMvc = MockMvcBuilders.webAppContextSetup(webApplicationContext).build();

        MvcResult mvcResult = mockMvc.perform(post("/api/quick-actions/plain-language/stream")
        ...
        mockMvc.perform(asyncDispatch(mvcResult))
                ...
                .andExpect(content().string(containsString("\"text\":\"Kurz und einfach: ")))
