...
@SpringBootTest
class MediumQuickActionControllerMvcTest {

    @Autowired
    private WebApplicationContext webApplicationContext;

    @Test
    void postMediumStreamReturnsSseChunksAndCompleteEvent() throws Exception {
        ...
        mockMvc.perform(asyncDispatch(mvcResult))
                ...
                .andExpect(content().string(containsString(
                        "\"text\":\"Bericht\\n\\nZusammenfassung: Projekt ist freigegeben.\\nDetails: Team startet am Montag.\\nAbschluss: Team startet am Montag.\""
                )));
    }

    @Test
    void postMediumStreamRequiresAnOption() throws Exception {
        MockMvc mockMvc = MockMvcBuilders.webAppContextSetup(webApplicationContext).build();

        mockMvc.perform(post("/api/quick-actions/medium/stream")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
    ...
    @Test
    void postMediumStreamRejectsUnknownOptions() throws Exception {
        MockMvc mockMvc = MockMvcBuilders.webAppContextSetup(webApplicationContext).build();
