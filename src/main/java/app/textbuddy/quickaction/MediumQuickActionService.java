...
@Service
public class MediumQuickActionService {
    ...
    public MediumQuickActionService(MediumLlmClient mediumLlmClient) {
    ...
    public void stream(
        ...
        Optional<MediumPrompt> prompt = MediumPrompt.fromOption(request == null ? null : request.option());
